...
const RUN_LOCAL = new Set(['ping','help','showcase','refund', 'about','vote','index', 'rehearsal','profile', 'tradecard', 'trademulti', 'grantrandom', 'grantpay', 'grantcard', 'list', 'balance', 'boutique', 'boutiquecards', 'addtemplate', 'boutiquepreview', 'boutiquetemplate', 'records', 'editcards', 'createcard', 'stall', 'stallpreview', 'spawn', 'recommend', 'recommendsubmit', 'recommendreset', 'recommendset', 'message']); // tiny/fast ones only
