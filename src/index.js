...
const RUN_LOCAL = new Set(['ping','help','about','vote','index', 'rehearsal','profile', 'tradecard', 'trademulti', 'grantrandom', 'grantpay', 'grantcard', 'list', 'balance', 'boutique', 'boutiquecards', 'records', 'editcards', 'createcard']); // tiny/fast ones only
