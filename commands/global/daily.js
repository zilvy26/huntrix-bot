...
module.exports = {
  ...
  const sopop = 4 + Math.min(8, Math.floor(streak / 60));       // +1 per 60 days, max +8
  const patterns = 6500 + Math.min(12500, Math.floor(streak / 15) * 400);  // +400 per 15 days, max +12000
